...
export const ABOUT_DATA = [
    ...
    },
    {
        ...
        name: "VIT ACM Student Chapter",
        info: `ACM VIT is a subsidiary of Association for Computing Machinery (ACM) , a worldwide learning society for computing. The chapter was founded on August 2, 2019. We see a world where computing helps solve tomorrow’s problems – where we use our knowledge and skills to advance the profession and make a positive impact.`,
        float: 'right'
    },
    {
        imageURL: AboutPicture3,
        name: "VIT ACM-W Student Chapter",
        info: `VIT ACM-W seeks to take forward the task of the ACM community, but with a particular focus on the empowerment of women in computing.
